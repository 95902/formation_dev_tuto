...
class SlackFormatterTest extends TestCase
{
    ...
    public function test_it_formats_an_answer_with_several_citations(): void
    {
        ...
        $this->assertSame($expected, (new SlackFormatter)->format($this->answerWithSeveralCitations()));
    }
    ...
    public function test_it_uses_the_singular_when_there_is_one_citation(): void
    {
        ...
        $this->assertSame($expected, (new SlackFormatter)->format($this->answerWithOneCitation()));
    }
    ...
    public function test_it_reports_when_there_are_no_citations(): void
    {
        ...
        $this->assertSame($expected, (new SlackFormatter)->format($this->answerWithNoCitations()));
    }
}
